...
/**
 * The push twin of {@link EmailDelegationInvitationPlugin} (EXO-90503): the same
 * title, sentence and link, on the device.
 */
public class EmailDelegationInvitationPwaPlugin extends BaseEmailDelegationNotificationPwaPlugin {
