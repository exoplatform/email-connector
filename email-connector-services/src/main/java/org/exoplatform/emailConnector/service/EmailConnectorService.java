...
public class EmailConnectorService {
   ...
   * @return stored {@link EmailConnectors} in datasource
   */
   ...
   */
  @SneakyThrows
  public InputStream getEmailConnectorImageInputStream(long emailConnectorId, String dimensions) throws IllegalAccessException {
    ...
    if (emailConnector == null) {
      ...
      if (dimensions != null && StringUtils.contains(dimensions, "x")) {
        ...
        FileItem thumbnailFileItem = imageThumbnailService.getOrCreateThumbnail(fileItem, dimensionParts[0], dimensionParts[1]);
        return getApplicationImageInputStream(thumbnailFileItem.getFileInfo().getId());
      } else {
