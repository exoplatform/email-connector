...
public class EmailConnectorRest {
  ...
  @PutMapping("enable/{isFeatureEnabled}")
  @Secured("administrators")
  @Operation(summary = "Enables/Disables email connector feature", method = "PUT", description = "This will enable/disable email connector feature")
  @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Request fulfilled"),
      @ApiResponse(responseCode = "400", description = "Bad Request"),
      @ApiResponse(responseCode = "403", description = "Forbidden"),
      @ApiResponse(responseCode = "404", description = "Not found"),
      @ApiResponse(responseCode = "409", description = "Conflict"), })
  public ResponseEntity<String> enable(@Parameter(description = "Is feature enabled")
  @PathVariable("isFeatureEnabled")
