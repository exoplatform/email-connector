...
<template>
  <exo-drawer
    ...
    <template v-if="userSettingConnectorsDrawer" #content>
      ...
      <v-list-item v-else class="mx-5 px-0 mt-16 align-center">
        <v-list-item-content>
